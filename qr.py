# Someone told me that we should always encrypt before sending data over network. So, I encrypted the flag. I hope it's secure now.
...
#correct flag = Flag{3xpl0itin1g_8oundar1es_w1th_8yte}